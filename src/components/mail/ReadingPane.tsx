...
export function ReadingPane() {
  ...
  return (
    <>
      {/*
        Right padding matches the reading pane's always-on scrollbar track
        (`lockGutter` on the scroller below). The header sits outside it, so
        without this the subject would extend 10px past the body.
      */}
      <header className="shrink-0 border-b border-border py-3 pl-5 pr-[calc(1.25rem+var(--scrollbar-size))]">
