...
pub const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 20,
        sql: M20_SENDER_INDEX_COVERS_NAME,
    },
];

/// Migration 20 — put the sender index back in front of the address book.
///
...
const M20_SENDER_INDEX_COVERS_NAME: &str = r#"
...
/// it was racing.
///
/// Superseded by [`M20_SENDER_INDEX_COVERS_NAME`], which replaces this index:
